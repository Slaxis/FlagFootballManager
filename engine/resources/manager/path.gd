...
func _init() -> void:
	_resolvers["rules"]       = func() -> String: return _find_content_asset_multi(game_config_name, JSON_EXTENSION)
	_resolvers["directories"] = func() -> String: return _find_content_asset_multi(game_config_name, JSON_EXTENSION)
...
func ui_path(ui_id: String, dirs: Directories) -> String:
	...
	var candidate: String = _module_root + "/" + ui_dir + "/" + ui_id + "/" + ui_id + "." + SCENE_EXTENSION
