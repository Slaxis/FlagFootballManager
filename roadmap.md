...
| 41 | **A ficha abre sorteada inteira, habilidades incluídas.** Preencher quinze barras do zero é tarefa, não escolha — e piorou com as origens, porque um ex-jogador sem habilidade não é um ex-jogador. Você recebe uma pessoa pronta e **editar ela é o jogo**. Os seis anos de sobra continuam abertos. |
