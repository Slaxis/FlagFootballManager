...
| **B.7** | `talentos-e-preto` | Os talentos viram **sigla de três letras** na criação (a tabela já era), nome e descrição no tooltip. E a página fica **preta**: `CANVAS` separado de `PANEL`, o clube veste as janelas e a seleção em vez do monitor, e o azul-marinho que a decisão 71 tinha mandado embora sai de verdade | ✅ |
