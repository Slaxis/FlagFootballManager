...
| 21 | **A criação é paga em anos de vida.** Você começa como uma criança sorteada de 12 anos — atributos em torno de 3, **habilidades todas em zero** — e gasta os seis anos até os 18. A idade sobe enquanto você distribui e volta quando você desfaz. Dá pra **vender a própria infância** até 1 passo num atributo e investir os anos em outro lugar (e sim, isso te deixa com menos de 12). Atributos e habilidades saem do mesmo bolso, porque treinar destreza e treinar lançamento melhoram a mesma jogada. **E você sai da tela aos 18 ou não sai**: o botão de começar fica fechado enquanto sobrar ponto. A moeda é o **career point**: entrar no passo N custa N pontos do próprio tipo, e um ponto de atributo vale 3 career points contra 2 de habilidade — crescer é mais caro que aprender. Um ano de vida dá 40. |
