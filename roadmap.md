...
| 84 | **Nada dentro de uma célula pode ser mais largo que a célula, e a coluna se mede contra o próprio cabeçalho.** Duas formas do mesmo erro, as duas achadas medindo. A criação virou 2x2 e saiu **500px MAIS LARGA** que a fila indiana que substituiu, porque três filhos continuavam dimensionados contra a coluna inteira. E três cabeçalhos do elenco estavam cortados sem ninguém ver: a face do corpo é monoespaçada em 12px por caractere, "Talento" tem 84px contra uma coluna de 34 — e o mais LARGO daquelas colunas é o cabeçalho e não o dado, então elas pareciam folgadas de toda linha menos a que as nomeia. |
